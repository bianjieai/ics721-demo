...
sed -i -e 's/timeout_propose = "3s"/timeout_propose = "10s"/g' $CHAIN_DIR/$CHAINID_1/config/config.toml
...
sed -i -e 's/timeout_propose = "3s"/timeout_propose = "10s"/g' $CHAIN_DIR/$CHAINID_2/config/config.toml
